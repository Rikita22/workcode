...
const Data = () => {
  return (
   <div className="home__data">
    <h1 className="home__title">Rikita Koley
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <h3 className="home__subtitle">Cloud Enthusiast</h3>
    <p className="home__description">I'm a software engineer based in India and I'm quite passionate and dedicated in what I do</p>
